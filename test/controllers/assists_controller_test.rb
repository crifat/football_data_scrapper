...
class AssistsControllerTest < ActionController::TestCase
  ...
  test "should create assist" do
    assert_difference('Assist.count') do
      post :create, assist: { match_id: @assist.match_id, player_id: @assist.player_id, player_name: @assist.player_name }
    end
  ...
  test "should update assist" do
    patch :update, id: @assist, assist: { match_id: @assist.match_id, player_id: @assist.player_id, player_name: @assist.player_name }
    assert_redirected_to assist_path(assigns(:assist))
  end
